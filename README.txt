...
We made this project in order to collect the sound which is recorded by Raspberry Pi with USB Sound Card and Microphone.The sound is recorded at 16000Hz sample rate. In the sound file, 8 pieces of data will be printed out by a .php file to a .txt file.
...
3.Operating instructions
	  ...
	  6. After "./sound.a", the microphone will start to record; the bar-diagram will show the changes on the screen due to the volume of              the sound you make and the duration of recording is 1 second. The program will calculate the rms value for every 200 samples of              data for a total of 80 values
